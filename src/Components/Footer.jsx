...
export const Footer = () => {
  return (
    <footer className="w-full bg-gray-950/70 backdrop-blur-md border-t border-gray-800 text-gray-300 z-10">
          ...
          <div className="space-y-4">
            ...
            <div className="flex mt-2">
              <input
                ...
                className="px-3 py-2 bg-gray-800 border border-gray-700 rounded-l-md focus:outline-none focus:ring-1 focus:ring-blue-500 text-sm w-full"
              />
